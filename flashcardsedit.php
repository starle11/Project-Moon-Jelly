...
<div class="form-container">
    ...
    <form method="post" action="">
        ...
        <input type="text" name="front_content" id="front_content" required>
        <label for="back_content">Back Content:</label>
        <input type="text" name="back_content" id="back_content" required>
        <button type="submit">Add/Edit Flashcard</button>

        <!-- Back to Flashcards Button -->
        <a href="flashcards.php?set_id=<?php echo $set_id; ?>">
            <button style="margin-right: 0;">Back to Flashcards</button>
        </a>
    </form>
</div>
